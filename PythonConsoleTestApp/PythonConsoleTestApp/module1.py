...
allEnumList = [e.value for e in BuiltInCategory]
newList = get_fam(allEnumList)
...
# assemblies = get_fam(BuiltInCategory.OST_Assemblies)allEnumList = [e.value for e in BuiltInCategory]
newList = get_fam(allEnumList)